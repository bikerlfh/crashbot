...
class CredentialDesigner(object):
    ...
    def retranslateUi(self, Credentials):
        ...
        self.cmb_home_bet.setItemText(0, _translate("Credentials", "Bet Play"))
        self.cmb_home_bet.setItemText(1, _translate("Credentials", "One win"))
        self.cmb_home_bet.setItemText(2, _translate("Credentials", "Demo"))
        self.cmb_home_bet.setItemText(3, _translate("Credentials", "Rivalo"))
